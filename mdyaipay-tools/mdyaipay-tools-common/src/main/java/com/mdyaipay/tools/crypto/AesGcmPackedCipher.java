...
/**
 * AES-GCM 打包格式：Base64(IV[12] + ciphertext+tag)，密钥为 32 字节 AES。
 */
public final class AesGcmPackedCipher {
    ...
    public AesGcmPackedCipher(byte[] keyBytes) {
    ...
    public String decryptUtf8(String cipherBase64) {
